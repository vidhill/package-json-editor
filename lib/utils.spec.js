...
describe("test 'getExistingRepositoryUrl()'", () => {
    ...
    it('should return the expected value, case existing value', () => {
        const result = getExistingRepositoryUrl({
            url: 'git+https://github.com/vidhill/package-json-editor.git',
        });
        expect(result).toBe('https://github.com/vidhill/package-json-editor');
    });
    it('should return the expected value, case no existing repo', () => {
        const result = getExistingRepositoryUrl(undefined);
