const checkVersionNumber = require('./check-version-number');

function makeRejectEmpty(id) {
    return (input) => {
        if (input.length === 0) {
    ...
    const questions = [
        {
            ...
            validate: makeRejectEmpty('package name'),
        },
        {
            type: 'input',
            name: 'description',
            ...
            validate: makeRejectEmpty('description'),
        },
        {
            type: 'input',
            name: 'repositoryUrl',
    ...
    const additionalQuestions = [
        {
            ...
            validate: makeRejectEmpty('author'),
        },
        {
            type: 'input',
            name: 'license',
            ...
            validate: makeRejectEmpty('license'),
        },
    ];
